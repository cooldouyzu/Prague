...
const tripDays = [
  {
    ...
    zoom: 14,
    note:
      "06:55 抵達後搭乘機場接駁車前往 W Prague 放行李。11:00 Café Imperial 已預約，13:00 克萊門特學院圖書館與天文塔導覽已預約，老城區行程依兩個固定時段重排。",
    items: [
      makeItem(
        "d1-01",
        "06:55-09:15",
      ...
      makeItem(
        ...
        "20-30 分鐘含緩衝",
        "13:00 圖書館與天文塔導覽已預約完成",
        "13:00 是固定預約，建議 12:20 左右離開 Café Imperial，12:45 前抵達克萊門特學院集合點。",
        ["booking", "warning"],
      ),
      makeItem(
        "d1-04",
      ...
      makeItem(
        ...
        "5-10 分鐘",
        "無",
        "克萊門特學院離查理大橋很近，13:00 導覽結束後直接往橋上散步最順。",
        [],
      ),
      makeItem(
        "d1-07",
