...
const tripDays = [
  {
    ...
    items: [
      makeItem(
        ...
        "45-70 分鐘",
        "確認接駁車集合點與飯店可寄放行李",
        "W Prague 位在瓦茨拉夫廣場。放完行李後，建議從 Můstek 搭地鐵 A 線 1 站到 Staroměstská，再步行約 8 分鐘到老城廣場；若想看街景，也可直接步行約 15-20 分鐘。若入境或接駁延誤，老城廣場與天文鐘時間需後移。",
  ...
  },
  {
    ...
    zoom: 13,
    note:
      "早上從 W Prague 出發到猶太區，可從 Můstek 搭地鐵 A 線到 Staroměstská 再步行；天氣好也可直接步行。已把慕夏博物館排入午餐後。",
    items: [
      makeItem(
        "d4-00",
        "08:35-09:00",
