...
const tripDays = [
  {
    ...
    zoom: 14,
    note:
      "06:55 抵達後搭乘機場接駁車前往 W Prague 放行李。11:00 Café Imperial、13:00 克萊門特學院導覽為固定預約；下午依序安排遊船、佩特任山、步行經查理大橋，晚餐建議預約 Restaurant Mlýnec 19:15。",
    items: [
      makeItem(
        "d1-01",
        "06:55-09:15",
      ...
      makeItem(
        "d1-09",
        "19:15-21:00",
        "晚餐：Restaurant Mlýnec",
        "Restaurant Mlýnec",
        [50.0854101, 14.4135949],
        "從佩特任山步行下山，經查理大橋到 Novotného lávka",
        "約 29-45 分鐘，另保留約 40 分鐘緩衝",
        "建議預約 19:15；17:30 風險較高",
        "地址：Novotného lávka 9, 110 00 Staré Město, 捷克。19:15 可容納佩特任停留、步行下山、查理大橋拍照與第一天可能發生的延誤。",
        ["booking", "transport", "warning"],
      ),
    ],
  },
